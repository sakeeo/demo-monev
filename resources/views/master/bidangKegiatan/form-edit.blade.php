        ...
        <div class="card shadow mb-4">
            ...
            <div class="row justify-content-md-center">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <form class="" action="{{ route('update.bidangKegiatan') }}" method="post">
                        @csrf

                        <input type="hidden" value="{{$old->id}}" name="id">
                        <div class="form-group">
                            <label for="" class="form-label">Bidang :</label>
                            <input class="form-control" value="{{$old->bidang}}" list="bidangs" name="bidang" id="bidang" required>
                            <datalist id="bidangs">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{$old->sub_bidang}}" list="sub_bidangs" name="sub_bidang" id="sub_bidang" required autocomplete="false">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{$old->kegiatan}}" name="kegiatan" id="kegiatan" required>
